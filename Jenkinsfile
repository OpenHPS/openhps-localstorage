pipeline {
    ...
    post {
        always {
            ...
            archiveArtifacts artifacts: 'dist/web/openhps-localstorage.js', fingerprint: true
            archiveArtifacts artifacts: 'dist/web/openhps-localstorage.js.map', fingerprint: true
            archiveArtifacts artifacts: 'dist/web/openhps-localstorage.min.js', fingerprint: true
            archiveArtifacts artifacts: 'dist/web/openhps-localstorage.min.js.map', fingerprint: true
            deleteDir()
        }
    }
}